...
export default {
  ...
  safelist: [
    ...
    'bg-profil-picture-blue',
    'bg-profil-picture-green',
    'bg-profil-picture-orange',
    'bg-profil-picture-yellow',
    'bg-profil-picture-red',
    'bg-profil-picture-pink',
    'bg-profil-picture-purple',
  ],
  theme: {
    fontFamily: {
    ...
    extend: {
      ...
      colors: {
        ...
        'profil-picture-blue': '#07BCD5',
        'profil-picture-green': '#35B888',
        'profil-picture-orange': '#F2682F',
        'profil-picture-yellow': '#F2DF2F',
        'profil-picture-red': '#ED1E1E',
        'profil-picture-pink': '#DD1D5E',
        'profil-picture-purple': '#9F13AF',
      },
      rotate: {
        17: '17deg',
      },
