    ...
    <div className='bg-pastel-blue flex h-screen items-center justify-center p-5'>
      ...
      >
        <div className='flex h-screen w-screen flex-col items-center justify-center'>
          ...
          >
            <input
              className='2px border-dark h-18 z-40 m-1 h-16 w-48 rounded border-[5px] p-1 text-center text-2xl md:w-80 md:text-3xl'
              type='birthdate'
            ...
            />
            <button
              className='button border-dark mt-3 w-[190px] rounded border-[5px] bg-blue-500 p-1 text-sm font-bold text-white hover:bg-blue-700 md:w-[320px] md:text-xl'
              type='submit'
            >
              {'Register'}
            </button>
      ...
      <div className='z-50'>
        {isImageShown && isSubmitted && birthdate !== '' ? (
          <div
            className={`w-7/8 ml-[5rem] h-screen ${''} animate-fade-out flex items-center justify-center`}
          >
            <img
              src='/ouch.svg'
