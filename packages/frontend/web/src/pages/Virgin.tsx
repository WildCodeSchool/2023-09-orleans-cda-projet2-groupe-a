      ...
      <div className='flex h-full w-full items-center justify-center'>
        <div className='bg-card-virgin-orange border-light-orange flex h-full w-full justify-center rounded-lg border-4 p-3 shadow-2xl sm:w-[70vw] md:h-[13rem] md:w-[27rem]'>
          <div className='flex h-full w-full flex-col items-center justify-center'>
            <h1 className='font-stroke text-light absolute z-50 m-auto mr-[200px] flex stroke-[2rem] py-[4rem] ps-5 text-center text-4xl text-[2.5rem] font-extrabold uppercase'>
              {'Virgin'}
            </h1>
            <div
              className='z-50 ml-[200px] h-[200px] w-[350px] bg-center bg-no-repeat'
              style={{
