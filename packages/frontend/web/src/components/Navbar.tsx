...
export default function Navbar() {
  ...
  return (
    <div className='flex justify-center'>
      <div className='ms:p-0 group fixed bottom-0 z-[100] flex w-[325px] flex-row-reverse justify-between rounded-t-lg p-2 backdrop-blur-xl sm:right-[10px] sm:top-[18px] sm:h-[33px] sm:w-auto sm:justify-end sm:bg-transparent sm:backdrop-blur-0'>
        <Link to='/'>
          <Home
