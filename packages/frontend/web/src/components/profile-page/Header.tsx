  ...
  return (
    <>
      ...
      <div className="gb-center relative right-[51%] flex h-[75%] w-[200%] items-center justify-center bg-[url('/profile-page/header-profile.png')] bg-contain bg-no-repeat sm:right-[0%] sm:m-2 sm:w-[97%] lg:m-6">
        ...
        />
        <div
          className='md:w-[500px]] absolute right-[18%] top-[27%] flex h-[450px] w-[450px] rotate-[25deg] items-center justify-center lg:right-[10%] lg:top-[27%] lg:h-[450px] lg:w-[450px] lg:rotate-[-20deg]'
          onClick={() => {
            setIsOpen(true);
          }}
        >
