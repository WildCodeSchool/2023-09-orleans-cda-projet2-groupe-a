    ...
    <>
      ...
      <div className='gb-center relative flex h-[30rem] w-[100%] items-center justify-center sm:right-[0%] sm:m-2 sm:w-[97%] lg:m-6'>
        ...
        <img
          ...
          className={`border-dark relative left-[1%] top-[-12%] ml-1 h-[1OOpx] w-[100px] cursor-pointer rounded-full border-[3px] bg-[#037EC3] transition-transform ease-in-out hover:scale-110 sm:left-[1%] sm:top-[-12%] sm:h-[125px] sm:w-[125px] sm:border-[6px] md:left-[1%] md:h-[150px] md:w-[150px] lg:left-[1%] lg:h-[200px] lg:w-[200px] xl:left-[1%] xl:h-[200px] xl:w-[200px] 2xl:left-[1%] 2xl:top-[-10%] 2xl:h-[300px] 2xl:w-[300px] bg-profile-picture-${color} object-cover`}
        />
        <img
