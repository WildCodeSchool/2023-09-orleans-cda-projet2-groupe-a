    ...
    <>
      ...
      <div className='gb-center relative flex h-[30rem] w-[100%] items-center justify-center sm:right-[0%] sm:m-2 sm:w-[97%] lg:m-6'>
        <img
          ...
          className='absolute -top-[1rem] h-[25rem] object-cover'
        />
        <img
          ...
          className={`border-dark relative left-[1%] top-[-12%] ml-1 h-[1OOpx] w-[100px] cursor-pointer rounded-full border-[3px] bg-[#2AB4FF] transition-transform ease-in-out hover:scale-110 sm:left-[1%] sm:top-[-12%] sm:h-[125px] sm:w-[125px] sm:border-[6px] md:left-[1%] md:h-[150px] md:w-[150px] lg:left-[2rem] lg:h-[200px] lg:w-[200px] xl:h-[200px] xl:w-[200px] bg-profile-picture-${color} object-cover`}
        />
        <img
