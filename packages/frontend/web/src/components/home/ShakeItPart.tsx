export default function ShakeItPart() {
  return (
    <div className='relative'>
      ...
      />
      <img
        className={`group-hover:filter-yellow duration-250  absolute left-[0px] top-[30px] transition-transform ease-in-out group-hover:scale-110 sm:left-[-10px] sm:top-[30px] md:left-[-10px] md:top-[30px] lg:left-[10px] xl:left-[75px] xl:top-[80px] 2xl:left-[160px] 2xl:top-[150px]`}
        src={`home/home-2.png`}
      />
    </div>
  );
