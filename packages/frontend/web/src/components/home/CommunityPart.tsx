export default function CommunityPart() {
  return (
    <div className='relative'>
      <h1 className='text-light font-stroke-navbar -rotate-17 relative top-[180px] z-50 w-[200px] text-center text-xl uppercase sm:left-[-10px] sm:top-[240px] sm:w-[300px] sm:text-[1.8rem] md:text-[2rem] lg:left-[-10px] lg:top-[280px] lg:text-[2.5rem] xl:left-[50px] xl:top-[300px] 2xl:left-[110px] 2xl:top-[370px]'>
        {'community'}
      </h1>
      <img
        src={`dot/dot-1.svg`}
