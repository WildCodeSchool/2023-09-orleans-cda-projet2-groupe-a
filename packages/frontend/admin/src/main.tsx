...
const App = () => (
  <Admin dataProvider={dataProvider}>
    ...
    <Resource name='glass' list={GlassList} edit={GlassEdit} />
    <Resource name='ingredient' list={IngredientList} edit={IngredientEdit} />
    <Resource name='topping' list={ToppingList} edit={ToppingEdit} />
