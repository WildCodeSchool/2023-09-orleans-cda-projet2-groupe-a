...
export async function down(db: Kysely<Database>): Promise<void> {
  await db.transaction().execute(async (trx) => {
    await sql`
      ...
      WHERE name IN ('Almond', 'Anise', 'Apple', 'Apricot', 'Avocado', 'Basil', 'Beer', 'Blackberry', 'Blueberry', 'Bourbon', 'Brandy', 'Cachaça', 'Cantaloupe', 'Caramel', 'Cauliflower', 'Champagne', 'Cherry', 'Chervil', 'Chives', 'Chocolate', 'Cilantro', 'Cinnamon', 'Clove', 'Coconut', 'Coffee', 'Coriander', 'Corn', 'Cranberry', 'Cucumber', 'Currant', 'Dill', 'Dragon Fruit', 'Eggplant', 'Fennel', 'Fig', 'Garlic', 'Gin', 'Ginger', 'Ginseng', 'Goji Berry', 'Grape', 'Green Bean', 'Green Tea', 'Guava', 'Hazelnut', 'Honey', 'Hops', 'Jalapeño', 'Jasmine', 'Kale', 'Kiwi', 'Lavender', 'Leek', 'Lemon', 'Lemongrass', 'Lime', 'Lychee', 'Mango', 'Maple Syrup', 'Marjoram', 'Melon', 'Mint', 'Mushroom', 'Nutmeg', 'Olive', 'Onion', 'Orange', 'Oregano', 'Papaya', 'Paprika', 'Parsley', 'Peach', 'Peanut', 'Pear', 'Peppermint', 'Persimmon', 'Pineapple', 'Pistachio', 'Plum', 'Pomegranate', 'Popcorn', 'Pork', 'Potato', 'Pumpkin', 'Red Wine', 'Rosé', 'Rum', 'Salmon', 'Salt', 'Scallion', 'Sesame Seed', 'Shallot', 'Shrimp', 'Snow Pea', 'Soy Sauce', 'Spinach', 'Strawberry', 'Sweet Potato', 'Tequila', 'Tarragon', 'Thyme', 'Tomato', 'Tuna', 'Turmeric', 'Turnip', 'Vanilla', 'Vodka', 'Walnut', 'Wasabi', 'Watermelon', 'Wheat Germ', 'White Wine', 'Yogurt', 'Zucchini', 'Whisky')
      ;
    `.execute(trx);
